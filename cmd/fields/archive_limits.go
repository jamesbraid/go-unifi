...
func (l ArchiveLimits) validate() error {
	if l.MaxImageTarBytes <= 0 || l.MaxBlobBytes <= 0 || l.MaxLayerBytes <= 0 || l.MaxJarBytes <= 0 || l.MaxJSONBytes <= 0 || l.MaxNoticeBytes <= 0 || l.MaxNestedExpandedBytes <= 0 || l.MaxEntries <= 0 || l.MaxNoticeEntries <= 0 || l.MaxNestedArchives <= 0 || l.MaxIndexDepth <= 0 {
