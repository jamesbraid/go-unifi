...
func TestGetHealth_MixedNumberRepresentations(t *testing.T) {
	...
	srv := siteHealthTestServer(t, site, `[
		{"subsystem":"wan","status":"ok","wan_ip":"203.0.113.10","gw_mac":"aa:bb:cc:dd:ee:ff",
		 "gateways":["203.0.113.1"],"latency":"12","xput_up":92.5,"tx_bytes-r":123456,
	...
	if wan.WanIP != "203.0.113.10" || wan.GwMac != "aa:bb:cc:dd:ee:ff" {
		t.Errorf("wan details = %q/%q, want 203.0.113.10/aa:bb:cc:dd:ee:ff", wan.WanIP, wan.GwMac)
	}
