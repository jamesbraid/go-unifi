...
func (c *ApiClient) ListWLAN(ctx context.Context, site string) ([]WLAN, error) {
	return envelopeList[WLAN](ctx, c, fmt.Sprintf("api/s/%s/rest/wlanconf", site))
}

func (c *ApiClient) GetWLAN(ctx context.Context, site string, id string) (*WLAN, error) {
	return envelopeOne[WLAN](ctx, c, http.MethodGet, fmt.Sprintf("api/s/%s/rest/wlanconf/%s", site, id), nil)
}

func (c *ApiClient) DeleteWLAN(ctx context.Context, site string, id string) error {
	return deleteResource(ctx, c, fmt.Sprintf("api/s/%s/rest/wlanconf/%s", site, id))
}

func (c *ApiClient) CreateWLAN(ctx context.Context, site string, d *WLAN) (*WLAN, error) {
	return envelopeOne[WLAN](ctx, c, http.MethodPost, fmt.Sprintf("api/s/%s/rest/wlanconf", site), d)
}
...
func (c *ApiClient) UpdateWLANFields(ctx context.Context, site string, d *WLAN, fields ...string) (*WLAN, error) {
	return envelopeMasked(ctx, c, fmt.Sprintf("api/s/%s/rest/wlanconf/%s", site, d.ID), d, fields, func() (*WLAN, error) { return c.GetWLAN(ctx, site, d.ID) })
}

func (c *ApiClient) UpdateWLAN(ctx context.Context, site string, d *WLAN) (*WLAN, error) {
	return envelopeUpdate(ctx, c, fmt.Sprintf("api/s/%s/rest/wlanconf/%s", site, d.ID), d, func() (*WLAN, error) { return c.GetWLAN(ctx, site, d.ID) })
}
