...
func (c *ApiClient) UpdateDHCPOptionFields(ctx context.Context, site string, d *DHCPOption, fields ...string) (*DHCPOption, error) {
	return c.updateDHCPOptionFields(ctx, site, d, fields)
}

// updateDHCPOptionFields writes only the named wire fields, leaving
// every other field on the stored object alone. See maskedBody.
func (c *ApiClient) updateDHCPOptionFields(
	ctx context.Context,
	site string,
	d *DHCPOption,
	fields []string,
