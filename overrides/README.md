...
internal v2 API — nothing here is extracted from Ubiquiti software. The
drift probe (see `docs/superpowers/plans/`, phase 1) is the mechanism for
keeping them honest against live controllers.
